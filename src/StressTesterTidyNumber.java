import java.util.*;
import java.io.*;
public class StressTesterTidyNumber
{
    ...
    private static void generator(PrintWriter input){   //Writes a single instance for a test case
        ...
        for(int i=0;i<TC;i++)
            input.println(Math.abs(rand.nextLong()) % MAX_N);
    }
    ...
    public static void main(String []args) throws IOException {
        ...
        {      
            ...
            TidyNumbersSlow.main(null);   // By default all solvers read from "input.txt"
            long t2 = System.nanoTime();
            
            long t3 = System.nanoTime();
            TidyNumbers.main(null);    // By default all solvers write to a file whose location is stored in a static String called outputFile
            long t4 = System.nanoTime();
            
            System.out.printf("time slow = %fs time fast = %fs \n" , ((t2 - t1) / 1e9) , ((t4 - t3) / 1e9));
            
            int verdict1 = JUDGE(TidyNumbersSlow.outputFile, TidyNumbers.outputFile);   
